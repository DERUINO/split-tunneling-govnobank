...
') do (
    taskkill /PID %%P% /F
    "ForceBindIP64.exe" %interface_ip% "C:\Users\%USERNAME%\AppData\Roaming\Telegram Desktop\Telegram.exe"
)
...
') do (
    taskkill /PID %%P% /F
    "ForceBindIP64.exe" %interface_ip% "C:\Users\%USERNAME%\AppData\Local\Programs\VK Teams\vkteams.exe"
)
